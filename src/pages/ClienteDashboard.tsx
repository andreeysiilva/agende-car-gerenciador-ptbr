...
import ClienteNavigation from '@/components/ClienteNavigation';
    ...
    <div className="min-h-screen bg-background">
      ...
      {menuAberto && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 md:hidden" onClick={() => setMenuAberto(false)}>
          <div className="bg-white w-80 h-full shadow-lg slide-up p-4" onClick={(e) => e.stopPropagation()}>
            <div className="mb-6">
              <h2 className="font-semibold text-text-primary mb-2">Menu Principal</h2>
            </div>
            <ClienteNavigation />
          </div>
        </div>
      ...
      <div className="flex">
        ...
        <aside className="hidden md:block w-80 bg-white border-r border-border h-screen sticky top-16">
          <div className="p-6">
            <h2 className="font-semibold text-text-primary mb-4">Navegação</h2>
            <ClienteNavigation />
          </div>
        </aside>

        {/* Conteúdo principal */}
        <main className="flex-1 p-4 max-w-none">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Card 
              ...
              onClick={() => navigate('/cliente/estatisticas')}
            >
              <CardContent className="p-6">
                <div className="flex items-center gap-3">
